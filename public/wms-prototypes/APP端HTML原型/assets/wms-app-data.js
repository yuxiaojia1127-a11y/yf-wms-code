(() => {
    ...
    const menuDefs = [
      ...
      { id: "shipping_redispatch", module: "shipping", label: "重新派单", code: "SH-02", desc: "处理需重新派单的发货任务" },
      { id: "shipping_wait_order", module: "shipping", label: "待接单", code: "SH-03", desc: "等待骑手或承运方接单" },
      { id: "shipping_accepted", module: "shipping", label: "已接单", code: "SH-04", desc: "配送任务已被接单待取货" },
      { id: "shipping_picked", module: "shipping", label: "已取货", code: "SH-05", desc: "订单已完成取货待配送" },
